...
date: "Slides em: bit.ly/RMDNEISSE"
...
knitr::include_graphics("img/python-modules.png")
```
...
knitr::include_graphics("img/airbnb-logo.png")
```
--
...
O R Markdown permite gerar relatórios personalizados **em massa** com programação!

Foi usado um template em R Markdown dentro de um `for()`, que pode ser checado [aqui](https://rmarkdown.rstudio.com/articles_mail_merge.html)!

--

# No Tribunal de Justiça de Mato Grosso!

No Menu de Estatística, criado recentemente, são usados relatórios em Rmarkdown e painéis em Qlik!

Você pode verificar [aqui](https://estatistica.tjmt.jus.br/) (e reclamar pra mim se estiver ruim).

```{r, echo=FALSE, out.height=170, out.width=700, fig.align='center'}
knitr::include_graphics("img/estatistica-tjmt.png")
```
...
```{r, echo=FALSE, out.height=325, out.width=325, fig.align='center'}
knitr::include_graphics("img/creation_frame.png")
```
...
knitr::include_graphics("img/format-dropdown.png")
```
...
```{r, echo=FALSE, out.height=125, out.width=250, fig.align='center'}
...
Utilizar `'r mean(1:10)'` retorna **`r mean(1:10)`** no ato de geração do documento.

Gera muitas possibilidades utilizando `ifelse()`, por exemplo.
...
Todas as opções de tabela para [HTML](http://haozhu233.github.io/kableExtra/awesome_table_in_html.html) e [PDF](http://haozhu233.github.io/kableExtra/awesome_table_in_pdf.pdf).
---
...
```{r, echo=FALSE, fig.align='center', out.height=150, out.width=200}
...
[Exemplo do meu site em **aneisse.com** '-'](aneisse.com)
...
Código da apresentação no [Github](https://github.com/aneisse/aneisse/tree/master/content/slides/rmd-tutorial)
